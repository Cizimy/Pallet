...
##### 2.3.4.1 クラス設計のJSON構造例

```json
{
  "$schema": "https://example.com/schemas/class-responsibility-definition-v1.json",
  "document_info": {
    "id": "CLS-001",
